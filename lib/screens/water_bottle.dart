...
class WaterBottle extends StatefulWidget {
  /// Color of the water
  var waterColor = AppColors.blue_color;
  var waterlevel;

  /// Color of the bottle
  var bottleColor = AppColors.black_color;

  /// Color of the bottle cap
  var capColor = AppColors.blue_grey;
...
class WaterBottlePainter extends CustomPainter {
  ...
  void paintGlossyOverlay(Canvas canvas, Size size, Paint paint) {
    paint.color = AppColors.white_color.withAlpha(20);
    canvas.drawRect(Rect.fromLTRB(0, 0, size.width * 0.5, size.height), paint);
    paint.color = AppColors.white_color.withAlpha(80);
    canvas.drawRect(
    ...
    final gradient = LinearGradient(
      ...
      colors: [
        AppColors.white_color.withAlpha(180),
        AppColors.white_color.withAlpha(0),
      ],
    ).createShader(rect);
    paint.color = AppColors.white_color;
